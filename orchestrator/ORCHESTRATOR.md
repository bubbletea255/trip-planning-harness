...
각 단계에서 해당 에이전트의 역할 파일(agents/)과 지침 파일(skills/)을 읽고 그대로 수행한다.
...
`agents/intake.md`를 읽어 역할을 파악하고, `skills/intake.md`를 읽어 절차를 따른다.
...
`01-intake.md`가 존재하는지 확인한 뒤, `agents/researcher.md`와 `skills/researcher.md`를 읽고 수행한다.
...
`01-intake.md`와 `02-research.md`가 모두 존재하는지 확인한 뒤, `agents/planner.md`와 `skills/planner.md`를 읽고 수행한다.
...
`03-itinerary.md`가 존재하는지 확인한 뒤, `agents/budget-analyst.md`와 `skills/budget-analyst.md`를 읽고 수행한다.
...
`03-itinerary.md`와 `04-budget.md`가 모두 존재하는지 확인한 뒤, `agents/report-composer.md`와 `skills/report-composer.md`를 읽고 수행한다.
...
`agents/judge.md`와 `skills/judge.md`를 읽고 수행한다.
